...
{
    public sealed class Product : Entity // não pode ser herdada por causa do sealed : 
    {
        ...
        private void ValidateDomain(string name, string description, decimal price, int stock, string image)
        {
            ...
            DomainExceptionValidation.When(description.Length < 5, "Invalid description! Too short minimal 5 characters");
